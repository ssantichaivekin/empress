...
* `python empress_cli.py <command> -fn <path to tree data file>`

For example, to run Costscape with default parameters, you run:
* `python empress_cli.py costscape -fn examples/heliconius.newick`
...
```bash
$ python empress_cli.py costscape --host examples/heliconius_host.nwk --parasite examples/heliconius_parasite.nwk \
...
```bash
$ python empress_cli.py clumpr --host examples/heliconius_host.nwk --parasite examples/heliconius_parasite.nwk \
