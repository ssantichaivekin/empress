...
* `python empress.py <command> -fn <path to tree data file>`

For example, to run Costscape with default parameters, you run:
* `python empress.py costscape -fn examples/heliconius.newick`
...
* `python empress.py costscape -fn examples/heliconius.newick -tl 0.5 -th 10 -dl 0.5 -dh 10 --outfile costscape-example-img.pdf --log`
...
* `python empress.py reconcile -fn examples/heliconius.newick -d 4 -t 2 -l 0`
...
* `python histogram empress.py -fn examples/heliconius.newick --csv foo.csv --histogram bar.pdf --ynorm`
...
* `python clumpr empress.py -fn examples/heliconius.newick --median --nmprs 4 --support`