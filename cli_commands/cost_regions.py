...
def add_cost_regions_to_parser(cost_regions_parser: argparse.ArgumentParser):
    ...
    cost_regions_parser.add_argument("-dl", "--duplication-low", metavar="<duplication_low>", default=1.0,
                                     type=float, help="duplication low floating point value "
                                                      "for cost regions viewer window")
    cost_regions_parser.add_argument("-dh", "--duplication-high", metavar="<duplication_high>", default=5.0,
                                     type=float, help="duplication high floating point value "
                                                      "for cost regions viewer window")
    cost_regions_parser.add_argument("-tl", "--transfer-low", metavar="<transfer_low>", default=1.0,
                                     type=float, help="transfer low floating point value "
                                                      "for cost regions viewer window")
    cost_regions_parser.add_argument("-th", "--transfer-high", metavar="<transfer_high>", default=5.0,
                                     type=float, help="transfer high floating point value "
                                                      "for cost regions viewer window")
    ...
    cost_regions_parser.add_argument("--log", action="store_true",
                                     help="set both axes to use log scale")
