...
def render(host_dict: dict, parasite_dict: dict, recon_dict: dict, event_frequencies: dict, show_internal_labels: bool = False, show_freq: bool = False, axes: Union[plt.Axes, None] = None):
