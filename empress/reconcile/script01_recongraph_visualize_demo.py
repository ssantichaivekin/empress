...
from empress.reconcile import recongraph_tools # for creating a reconciliation graph
...
result = recongraph_tools.reconcile("./newickSample/size5/test-size5-no700.newick", 2, 4, 2)
