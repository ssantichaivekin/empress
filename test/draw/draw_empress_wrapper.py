...
class DrawEmpressWrapper(unittest.TestCase):
    ...
    def test_strong_consistency_reconciliation_draw_show_label_and_freq(self):
        fig = self.example_strong_consistent_reconciliation.draw(show_internal_labels=True, show_freq=True)
        fig.savefig(Path(common.output_path).joinpath(
    ...
    def test_strong_consistency_reconciliation_draw_hide_label_and_freq(self):
        fig = self.example_strong_consistent_reconciliation.draw(show_internal_labels=False, show_freq=False)
        fig.savefig(Path(common.output_path).joinpath(
